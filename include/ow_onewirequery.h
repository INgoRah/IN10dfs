...
int OWQ_format_output_offset_and_size(const char *string, size_t length, struct one_wire_query *owq);
int OWQ_format_output_offset_and_size_z(const char *string, struct one_wire_query *owq);
