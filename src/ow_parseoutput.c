...
static size_t OWQ_parse_output_array_no_commas(struct one_wire_query *owq);
static size_t OWQ_parse_output_ascii_array(struct one_wire_query *owq);
static size_t OWQ_parse_output_offset_and_size_z(const char *string, struct one_wire_query *owq) ;
static size_t OWQ_parse_output_offset_and_size(const char *string, size_t length, struct one_wire_query *owq) ;
...
{
	size_t ret = OWQ_parse_output_offset_and_size_z(string,owq) ;
	if ( ret > 0 ) {
		return 0 ;
	}
	return ret ;
...
{
	size_t ret = OWQ_parse_output_offset_and_size(string,length,owq) ;
	if ( ret > 0 ) {
		return 0 ;
	}
	return ret ;
...
static size_t OWQ_parse_output_offset_and_size(const char *string, size_t length, struct one_wire_query *owq)
{
	...
	//Debug_Bytes("OWQ_parse_output_offset_and_size", (const uint8_t *) string, length);
