...
static int FS_read_owq(struct one_wire_query *owq);
static int FS_structure(struct one_wire_query *owq);
static int FS_read_all_bits(struct one_wire_query *owq_byte);
static int FS_read_a_bit( struct one_wire_query *owq_bit );
static void adjust_file_size(struct one_wire_query *owq) ;
static int FS_read_distribute(struct one_wire_query *owq) ;
static int FS_read_all( struct one_wire_query *owq_all );
static int FS_read_a_part( struct one_wire_query *owq_part );
static int FS_read_in_parts( struct one_wire_query *owq_all );
